      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            По благосоловению митрополита Астанайского и Казахстанского Александра
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <p className="text-muted-foreground">
              Будем совершать вместе литургию - общее дело, совместно исполнять утреннее и вечернее правило, а также,
          ...
          <div className="text-center p-6">
            ...
            <p className="text-muted-foreground">
              ...
              реализовывать в себе идеи вечных ценностей. 
            </p>
          </div>
