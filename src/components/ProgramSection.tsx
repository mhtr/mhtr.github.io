...
const scheduleData = {
  "day1": {
    ...
    sessions: [
      ...
      { time: "19:40", title: "Вступительное слово председателя коммиссии по делам молодежи", speaker: "иерей Георгий Рублинский" },
  ...
  "day3": {
    ...
    sessions: [
      { time: "6:10", title: "Подъем", speaker: "" },
      { time: "6:30", title: "Выезд в Вознесенский кафедральный собор на Божественную Литургию", speaker: "" },
      { time: "8:00", title: "Прибытие", speaker: "" },
      { time: "8:30", title: "Начало Божественной Литургии", speaker: "" },
      { time: "11:00", title: "Выезд из Вознесенского кафедрального собора на трапезу в Свято-Казанский собор", speaker: "" },
